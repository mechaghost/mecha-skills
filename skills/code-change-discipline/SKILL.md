...
- For multi-step work, derive the execution checklist/todo tracker from a clear plan, not from first impressions.
- For large/risky work, harden the plan with three expert perspectives before editing.
...
- Run a quick review for small changes and a project-specific deep review for non-trivial changes before final verification.
